  ...
  sections: [
...

    {
      ...
      blocks: [
        ...
        { kind: 'callout', text: 'Open the site on your phone, scroll to the bottom and tap the ABN. It tries to call it. That is the whole problem in ten seconds.' },
